...
searchButtonEl.innerHTML = "Qidirish";
...
function createProfileEl(profileData) {
  ...
  element.innerHTML = `
    ...
    <p class="search-text"><span>Ism: </span>${profileData.name}</p>
    <p class="search-text"><span>Shahar: </span>${profileData.location}</p>
    <p class="search-text"><span>Akkaunt egasi haqida: </span>${profileData.bio}</p>
  `
